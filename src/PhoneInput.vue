...
//        } else {
//          let phonesDataCopy = {}
//          this.availableData.forEach((li) => {
//            if (li.name.toLowerCase().includes(this.search.trim().toLowerCase())) {
//              phonesDataCopy = Object.assign(phonesDataCopy, li)
//            }
//          })
//        }
        const phonesDataCopy = Object.assign({}, this.availableData)
        ...
        this.toFront.forEach((code) => {
          ...
          if (isObject(item)) {
            if (item.name.toLowerCase().includes(this.search.trim().toLowerCase())) {
        ...
        Object.values(phonesDataCopy).forEach(item => { if (item.name.toLowerCase().includes(this.search.trim().toLowerCase())) otherItems.push(item)})
